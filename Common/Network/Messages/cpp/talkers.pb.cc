...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_talkers_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::messages::Machine, bodycount_),
  PROTOBUF_FIELD_OFFSET(::messages::Machine, averageactivity_),
  PROTOBUF_FIELD_OFFSET(::messages::Machine, maximumactivity_),
  PROTOBUF_FIELD_OFFSET(::messages::Machine, tree_),
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_talkers_2eproto = {
  &descriptor_table_talkers_2eproto_initialized, descriptor_table_protodef_talkers_2eproto, "talkers.proto", 159,
