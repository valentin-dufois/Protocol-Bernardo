...
const Datagram_Type Datagram_Type_Type_MAX = Datagram_Type_TRACKED_BODIES;
...
class Endpoint : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.network.messages.Endpoint) */ {
 public:
  Endpoint();
  virtual ~Endpoint();
...
class Ping : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.network.messages.Ping) */ {
 public:
  Ping();
  virtual ~Ping();
...
class MasterStatus : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.network.messages.MasterStatus) */ {
 public:
  MasterStatus();
  ...
  static const int kConnectedDevicesFieldNumber = 20;
  ...
  const ::google::protobuf::RepeatedPtrField< ::std::string>& connecteddevices() const;
  ::google::protobuf::RepeatedPtrField< ::std::string>* mutable_connecteddevices();
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::std::string> connecteddevices_;
  mutable int _cached_size_;
  friend void  protobuf_AddDesc_network_2eproto();
  friend void protobuf_AssignDesc_network_2eproto();
  friend void protobuf_ShutdownFile_network_2eproto();
...
class Datagram : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.network.messages.Datagram) */ {
 public:
  Datagram();
  virtual ~Datagram();
  ...
  static const Type CALIBRATION_SET =
    Datagram_Type_CALIBRATION_SET;
  static const Type CALIBRATION_VALUES =
    Datagram_Type_CALIBRATION_VALUES;
  static const Type TRACKED_BODIES =
...
template <> struct is_proto_enum< ::pb::network::messages::Endpoint_Type> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::pb::network::messages::Datagram_Type> : ::google::protobuf::internal::true_type {};
template <>
