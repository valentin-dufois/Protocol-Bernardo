...
inline ::PROTOBUF_NAMESPACE_ID::int32 Machine::_internal_bodycount() const {
  return bodycount_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Machine::bodycount() const {
  // @@protoc_insertion_point(field_get:messages.Machine.bodyCount)
  return _internal_bodycount();
}
inline void Machine::_internal_set_bodycount(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  bodycount_ = value;
}
inline void Machine::set_bodycount(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline float Machine::_internal_averageactivity() const {
...
inline void Machine::_internal_set_averageactivity(float value) {
...
inline float Machine::_internal_maximumactivity() const {
...
inline void Machine::_internal_set_maximumactivity(float value) {
...
inline bool Machine::_internal_tree() const {
  return tree_;
}
...
inline void Machine::_internal_set_tree(bool value) {
