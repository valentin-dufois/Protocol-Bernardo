...
template<> ::messages::RawBodies* Arena::CreateMaybeMessage<::messages::RawBodies>(Arena*);
...
class RawBodies :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:messages.RawBodies) */ {
 public:
  RawBodies();
  virtual ~RawBodies();
  ...
  ::messages::RawBody* mutable_rawbodies(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::messages::RawBody >*
      mutable_rawbodies();
  private:
  const ::messages::RawBody& _internal_rawbodies(int index) const;
  ::messages::RawBody* _internal_add_rawbodies();
  public:
  const ::messages::RawBody& rawbodies(int index) const;
  ::messages::RawBody* add_rawbodies();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::messages::RawBody >&
      rawbodies() const;

  // @@protoc_insertion_point(class_scope:messages.RawBodies)
 private:
  class _Internal;

  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::messages::RawBody > rawbodies_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_body_2eproto;
};
// -------------------------------------------------------------------
...
inline ::messages::RawBody* RawBodies::mutable_rawbodies(int index) {
  // @@protoc_insertion_point(field_mutable:messages.RawBodies.rawBodies)
  return rawbodies_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::messages::RawBody >*
RawBodies::mutable_rawbodies() {
  // @@protoc_insertion_point(field_mutable_list:messages.RawBodies.rawBodies)
  return &rawbodies_;
}
inline const ::messages::RawBody& RawBodies::_internal_rawbodies(int index) const {
  return rawbodies_.Get(index);
}
inline const ::messages::RawBody& RawBodies::rawbodies(int index) const {
  // @@protoc_insertion_point(field_get:messages.RawBodies.rawBodies)
  return _internal_rawbodies(index);
}
inline ::messages::RawBody* RawBodies::_internal_add_rawbodies() {
  return rawbodies_.Add();
}
inline ::messages::RawBody* RawBodies::add_rawbodies() {
  // @@protoc_insertion_point(field_add:messages.RawBodies.rawBodies)
  return _internal_add_rawbodies();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::messages::RawBody >&
