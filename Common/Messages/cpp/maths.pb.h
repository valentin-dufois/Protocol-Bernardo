...
class Empty : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:messages.Empty) */ {
 public:
  Empty();
  virtual ~Empty();
...
class vec2 : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:messages.vec2) */ {
 public:
  vec2();
  virtual ~vec2();
...
class vec3 : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:messages.vec3) */ {
 public:
  vec3();
  virtual ~vec3();
...
class vec4 : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:messages.vec4) */ {
 public:
  vec4();
  virtual ~vec4();
