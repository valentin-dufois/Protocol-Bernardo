...
class Screen :
 ...
 public:
  ...
  private:
  const ::messages::vec2& _internal_size() const;
  ::messages::vec2* _internal_mutable_size();
  public:
...
class Layout :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::messages::Device >*
      mutable_devices();
  private:
  const ::messages::Device& _internal_devices(int index) const;
  ::messages::Device* _internal_add_devices();
  public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::messages::Screen >*
      mutable_screens();
  private:
  const ::messages::Screen& _internal_screens(int index) const;
  ::messages::Screen* _internal_add_screens();
  public:
...
inline const ::messages::vec3& Device::_internal_position() const {
...
inline ::messages::vec3* Device::_internal_mutable_position() {
...
inline const ::messages::vec3& Device::_internal_orientation() const {
...
inline ::messages::vec3* Device::_internal_mutable_orientation() {
...
inline const ::messages::vec3& Screen::_internal_position() const {
  const ::messages::vec3* p = position_;
  return p != nullptr ? *p : *reinterpret_cast<const ::messages::vec3*>(
      &::messages::_vec3_default_instance_);
}
...
inline ::messages::vec3* Screen::_internal_mutable_position() {
...
inline const ::messages::vec3& Screen::_internal_orientation() const {
  const ::messages::vec3* p = orientation_;
  return p != nullptr ? *p : *reinterpret_cast<const ::messages::vec3*>(
      &::messages::_vec3_default_instance_);
}
...
inline ::messages::vec3* Screen::_internal_mutable_orientation() {
...
inline const ::messages::vec2& Screen::_internal_size() const {
...
inline ::messages::vec2* Screen::_internal_mutable_size() {
...
inline const ::messages::Device& Layout::_internal_devices(int index) const {
...
inline ::messages::Device* Layout::_internal_add_devices() {
  return devices_.Add();
}
...
inline const ::messages::Screen& Layout::_internal_screens(int index) const {
...
inline ::messages::Screen* Layout::_internal_add_screens() {
  return screens_.Add();
}
