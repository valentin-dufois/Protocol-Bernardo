...
struct Messages_Joint {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var orientation: Messages_vec4 {
    get {return _storage._orientation ?? Messages_vec4()}
  ...
  var position2D: Messages_vec2 {
    get {return _storage._position2D ?? Messages_vec2()}
...
struct Messages_Skeleton {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var joints: [Messages_Joint] {
    get {return _storage._joints}
    set {_uniqueStorage()._joints = newValue}
  }

  var centerOfMass: Messages_vec3 {
    get {return _storage._centerOfMass ?? Messages_vec3()}
...
struct Messages_RawBody {
  ...
  var skeleton: Messages_Skeleton {
    get {return _storage._skeleton ?? Messages_Skeleton()}
  ...
  var state: Messages_RawBody.State {
...
extension Messages_RawBody.State: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Messages_RawBody.State] = [
    .error,
    .noSkeleton,
    .calibrating,
    .tracked,
...
struct Messages_RawBodies {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var rawBodies: [Messages_RawBody] = []
...
extension Messages_Joint: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _orientation: Messages_vec4? = nil
    var _orientationConfidence: Double = 0
    var _position: Messages_vec3? = nil
    var _position2D: Messages_vec2? = nil
  ...
  static func ==(lhs: Messages_Joint, rhs: Messages_Joint) -> Bool {
...
extension Messages_Skeleton: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _joints: [Messages_Joint] = []
    var _centerOfMass: Messages_vec3? = nil
  ...
  static func ==(lhs: Messages_Skeleton, rhs: Messages_Skeleton) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Messages_RawBody: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _uid: Int32 = 0
    var _skeleton: Messages_Skeleton? = nil
    var _state: Messages_RawBody.State = .error
  ...
  static func ==(lhs: Messages_RawBody, rhs: Messages_RawBody) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Messages_RawBody.State: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "error"),
...
extension Messages_RawBodies: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Messages_RawBodies, rhs: Messages_RawBodies) -> Bool {
