...
DEFINE_bool(liveview, false, "Enable liveview from the connected devices. Liveview is useful for placing captation devices but should not be used for live performances as it degrades the tracker performances.");
